...
const seed = async ()=> {
    ...
    const albums =[
        ...
        {band:"Despicable",title:"Tell me why",authors:"Ain, Nothing, But, A, Mistake",releaseDate:"2015-10"},
        {band:"Me",title:"My guy",authors:"Half life-os budi",releaseDate:"2018-02-09"},
    ]
    
    for (const entry of albums){
        await db.run("INSERT INTO albums (day, class_list) VALUES (?, ?)", 
                    [entry.day,JSON.stringify(entry.albums)]);
    }
}
seed();
